...
**Status:** Phase 2 done, Phase 3 in progress ([docs/ROADMAP.md](./docs/ROADMAP.md)). Local pin: **L9 done → next L11 manual real-key E2E** ([docs/L11_MANUAL_E2E.md](./docs/L11_MANUAL_E2E.md)), then L10 stats. GET/HEAD fallback + static feed + cost estimate; client keys stay on the configured upstream origin; POST never auto-fallbacks. Default **`127.0.0.1:16191`**. Dashboard: `/dashboard/`. Not production-ready. Paid APIs: user-run only unless maintainers explicitly approve.
