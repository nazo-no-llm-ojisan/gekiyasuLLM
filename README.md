...
**Status:** Phase 1 in progress ([docs/ROADMAP.md](./docs/ROADMAP.md)). Local pin: **L7 done → next L9** (CostEstimate) or L8/L11. Default **`127.0.0.1:16191`**. Dashboard: `/dashboard/`. Not production-ready.
...
**現状:** 大枠 **Phase 1 進行中**。ローカル **L7 完了→次 L9**（[docs/ROADMAP.md](./docs/ROADMAP.md)）。既定 **`127.0.0.1:16191`** / dashboard `/dashboard/`。まだ本番向けではありません。
