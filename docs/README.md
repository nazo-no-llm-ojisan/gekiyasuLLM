...
| [ROADMAP_LOCAL.md](./ROADMAP_LOCAL.md) | **ローカル節** L0–L11 と現在位置・次の一手 |
...
| ファイル | 内容 |
|---|---|
| [IMPLEMENTATION_STATUS.md](./IMPLEMENTATION_STATUS.md) | 設計MVP vs 実装のギャップ |
| [FAILURE_TAXONOMY.md](./FAILURE_TAXONOMY.md) | 失敗分類 |
